...
public class Buget
{
	...
	void Transfer(int ToAccount_ID, int FromAccount_ID, double Amount, String Note, String Date)
	{
		transactions.createTransfer(ToAccount_ID, FromAccount_ID, Amount, Note, Date);
